...
object test {
  def main(args: Array[String]): Unit = {
    ...
    if (confirmOrder == "n") {
      ...
      if (countCoinTwo == 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinTwo pièce de 2 CHF"
      } else if (countCoinTwo > 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinTwo pièces de 2 CHF"
      }
      if (countCoinOne == 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinOne pièce de 1 CHF"
      } else if (countCoinOne > 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinOne pièces de 1 CHF"
      }
      if (countCoinFifty == 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinFifty pièce de 50 Centimes"
      } else if (countCoinFifty > 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinFifty pièces de 50 Centimes"
      }
      if (countCoinTwenty == 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinTwenty pièce de 20 Centimes"
      } else if (countCoinTwenty > 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinTwenty pièces de 20 Centimes"
      }
      if (countCoinTen == 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinTen pièce de 10 Centimes"
      } else if (countCoinTen > 1) {
        if (changeString != "") {
          changeString = s"$changeString, "
        }
        changeString = s"$changeString$countCoinTen pièces de 10 Centimes"
      }
      println(s"$promptChangeCancelled $changeString")
